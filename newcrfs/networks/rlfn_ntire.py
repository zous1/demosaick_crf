...
from networks import rlfn_block
...
class RLFN_Prune(nn.Module):
    ...
    def __init__(self,
        ...
        self.block_1 = rlfn_block.RLFB(feature_channels, mid_channels)
        self.block_2 = rlfn_block.RLFB(feature_channels, mid_channels)
        self.block_3 = rlfn_block.RLFB(feature_channels, mid_channels)
        self.block_4 = rlfn_block.RLFB(feature_channels, mid_channels)
